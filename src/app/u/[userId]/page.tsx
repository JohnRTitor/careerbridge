  ...
  if (profile.is_private) {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center p-8 text-center bg-background">
        ...
        <p className="text-muted-foreground mt-2 max-w-md">
          {profile.name ? `${profile.name} has` : "This user has"} chosen to
          keep their profile information private.
        </p>
      </div>
    );
  }
                ...
                <Card className="border-border shadow-sm bg-card">
                  ...
                  <CardContent className="space-y-6">
                    {profile.experience.map((exp) => (
                      <div
                        key={exp.id}
                        className="relative pl-6 before:absolute before:left-1.5 before:top-2 before:bottom-0 before:w-0.5 before:bg-border last:before:hidden"
                      >
                    ...
                    {profile.education.map((edu) => (
                      ...
                      >
                        ...
                        <div className="text-sm text-muted-foreground mt-0.5 mb-2">
                          ...
                          <span className="mx-1.5">•</span>
                          {edu.start_date
                            ? new Date(edu.start_date as string).getFullYear()
                            : ""}{" "}
                          -{" "}
                          {edu.end_date
                            ? new Date(edu.end_date as string).getFullYear()
                            : "Present"}
                        </div>
                        {edu.description && (
                          <p className="text-sm text-muted-foreground whitespace-pre-wrap">
