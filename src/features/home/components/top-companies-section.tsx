...
async function TopCompaniesContent() {
...
export function TopCompaniesSection() {
  return (
    <section id="companies" className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      ...
      <Suspense fallback={<div className="mt-12 h-64 flex items-center justify-center text-muted-foreground">Loading companies...</div>}>
        <TopCompaniesContent />
      </Suspense>
    </section>
  );
