...
import { Dialog, DialogPopup, type DialogProps } from "@/components/animate-ui/components/base/dialog"
import {
  InputGroup,
  InputGroupAddon,
...
const CommandDialog = ({ children, ...props }: Omit<DialogProps, "children"> & { children?: React.ReactNode }) => {
  return (
    <Dialog {...props}>
      <DialogPopup className="overflow-hidden p-0 shadow-lg max-w-lg mx-auto mt-20">
