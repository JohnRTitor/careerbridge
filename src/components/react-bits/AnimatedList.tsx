...
const AnimatedList: React.FC<AnimatedListProps> = ({
  ...
  return (
    <div className={cn("relative w-[500px]", className)}>
      <div
        ref={listRef}
        className={cn("max-h-[400px] overflow-y-auto p-4 ${ displayScrollbar ? '[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#120F17] [&::-webkit-scrollbar-thumb]:bg-[#222] [&::-webkit-scrollbar-thumb]:rounded-[4px]' : 'scrollbar-hide' }", className)}
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div className={cn("p-4 bg-[#111] rounded-lg ${selectedIndex === index ? 'bg-[#222]' : ''} ${itemClassName}", className)}>
